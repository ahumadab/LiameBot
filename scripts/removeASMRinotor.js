module.exports = {
    ...
    execute(message) {
      if (
          ...
          const position =
          message.content.indexOf("https://youtu.be") !== -1
            ? message.content.indexOf("https://youtu.be")
            : message.content.indexOf("https://www.youtube");
      ...
      if (match && match[7].length === 11) {
        ...
        await axios
          .get(
            `https://youtube.googleapis.com/youtube/v3/videos?part=snippet&id=${idYoutube}&key=${googleApiKey}`
          )
          .then((res) => {
